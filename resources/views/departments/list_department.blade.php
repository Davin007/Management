...
@section('content')
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <table class="display hidden" cellpadding="100%" cellspacing="0" id="department-list">
                <thead>
                <tr>
                    <th>ID</th>
...
@section('script')
    ...
    <script type="text/javascript">
        jQuery(document).ready(function () {
            var app = new App();
            jQuery('.loading').hide();
            jQuery('#department-list').removeClass('hidden');
            var info = [
                {'data': 'id'},
            ...
            app.DataTableHelper('#department-list', '/api/department/list', info);
            app.getEdit('.edit-department', 'api/department/get-edit-department');
            app.getAdd('.add-department','/api/department/get-add-department');
            app.closeModal('#cancel', '#myModal', '#myModal form');
            app.delete('.delete-department', 'api/department/delete');
        });
    </script>
